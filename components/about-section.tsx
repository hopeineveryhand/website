      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Explore3 brings together high school students passionate about Law, Medicine, and Science in the GTA's most
          ...
          <Card className="border-4 border-gray-900 shadow-lg">
            ...
            <CardContent>
              <p className="text-gray-600 text-center">
                Three competitive tracks: Pre-Law, Pre-Med, and Pre-STEM with prizes and recognition.
              </p>
            </CardContent>
          </Card>
        ...
        <div className="bg-gray-900 border-4 border-yellow-500 rounded-lg p-8">
          <h3 className="text-2xl font-bold text-yellow-500 mb-6 text-center">Competition Tracks</h3>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="bg-red-600 text-white font-bold py-2 px-4 rounded mb-4">PRE-LAW</div>
              <p className="text-gray-300">Legal case analysis, argumentation, and constitutional law challenges.</p>
            </div>
            <div className="text-center">
              <div className="bg-yellow-500 text-gray-900 font-bold py-2 px-4 rounded mb-4">PRE-MED</div>
              <p className="text-gray-300">
                Medical ethics, healthcare policy, and clinical decision-making scenarios.
              </p>
            </div>
            <div className="text-center">
              <div className="bg-red-600 text-white font-bold py-2 px-4 rounded mb-4">PRE-STEM</div>
              <p className="text-gray-300">Scientific research, innovation challenges, and technology solutions.</p>
            </div>
          </div>
        </div>
      </div>
