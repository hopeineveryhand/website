...
export default function TeamSection() {
  ...
  const unaffiliatedMembers = [
    {
      ...
      role: "Supervisor",
      description:
        "Supervisor of the Explore Three Competition, award winning TDSB educator with a passion for interdisciplinary education.",
    },
  ]
  ...
  return (
    <section id="team" className="bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 py-20">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-blue-500 mb-4 font-playfair">Organizing Committee</h2>
          <p className="text-lg text-gray-300 max-w-3xl mx-auto mb-6 leading-relaxed">
            EX<span className="text-red-600">3</span> represents collaboration between three innovative student
            organizations, creating an interdisciplinary platform for future leaders.
          </p>
          <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-red-600 mx-auto"></div>
        </div>

        {/* Partner Organizations */}
        <div className="mb-16">
          <h3 className="text-2xl font-bold text-blue-500 mb-8 text-center">Partner Organizations</h3>
          <div className="flex justify-center">
            <div className="grid lg:grid-cols-3 gap-8 justify-center max-w-6xl mx-auto">
              {clubs.map((club, index) => (
                <Card
                  key={index}
                  className={`bg-gray-800/90 border-4 ${getColorClasses(club.color)} shadow-xl hover:shadow-blue-500/10 transition-all duration-300 group backdrop-blur-sm`}
                >
                  <CardHeader className="text-center pb-4">
                    ...
                    <CardTitle className="text-blue-500 text-xl font-playfair mb-2">{club.name}</CardTitle>
                    ...
                    <div className="flex flex-col items-center space-y-2">
                      <div className="flex space-x-4">
                        <a
                          ...
                          className="text-red-600 hover:text-blue-500 transition-colors p-2 rounded-full hover:bg-gray-700/50"
                          title="Visit Website"
                        >
                      ...
                      {club.email !== "TBD" && (
                        <a
                          href={`mailto:${club.email}`}
                          className="text-blue-400 hover:text-red-600 transition-colors text-sm font-medium"
                        >
                          {club.email}
                        </a>
                      )}
                          ...
                          <div className="flex-1">
                            {member.website ? (
                              <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-white hover:text-blue-500 font-semibold transition-colors flex items-center group"
                              >
                                {member.name}
        ...
        <div className="mb-16">
          ...
          <div className="flex justify-center">
            <Card className="bg-gray-800/90 border-4 border-red-600 hover:border-red-500 shadow-xl hover:shadow-red-600/10 transition-all duration-300 group backdrop-blur-sm">
              <CardContent className="p-6">
                <div className="text-center">
                  <h4 className="text-white font-semibold text-xl mb-2">{unaffiliatedMembers[0].name}</h4>
                  <p className="text-red-400 text-base font-medium mb-3">{unaffiliatedMembers[0].role}</p>
                  <p className="text-gray-400 text-sm leading-relaxed">{unaffiliatedMembers[0].description}</p>
                </div>
              </CardContent>
            </Card>
          </div>
        ...
        {/* Contact Information */}
        <div className="text-center bg-gradient-to-r from-gray-800/90 to-blue-900/90 border-4 border-red-600 rounded-xl p-8 shadow-2xl backdrop-blur-sm">
          <h3 className="text-2xl font-bold text-red-600 mb-4">Connect With Our Team</h3>
          <div className="flex flex-col items-center space-y-2 text-blue-500 mb-4">
